export const risks = [
  {
    ...
    body: `All terms used in this notice, which are defined in the Neo Exchanger Terms of Use (the
“Terms of Use”), have the same meaning and construction as in the Terms of Use.`,
  },
  {
    heading: "B. Neo Exchanger Services",
    body: `This notice provides you with information about the risks associated with Neo Exchanger
Services. Each Neo Exchanger Service has its own distinct risks. This notice provides a
general description of the risks when you use Neo Exchanger Services.
...
decision to use Neo Exchanger Services.
`,
  },
  {
...
No communication or information provided to you by Neo Exchanger is intended as, or
...
`,
  },
  {
    ...
    body: `Neo Exchanger is not your broker, intermediary, agent, or advisor and has no fiduciary
relationship or obligation to you in connection with any trades or other decisions or activities
undertaken by you using Neo Exchanger Services. We do not monitor whether your use
of Neo Exchanger Services is consistent with your financial goals and objectives. It is up
...
transacting on the Neo Exchanger Services, and you acknowledge that Coins
Exchange does not provide legal or tax advice relative to these transactions. If you have
any doubts about your tax status or obligations when using Neo Exchanger Services, or
with respect to the Digital Assets held to the credit of your Neo Exchanger account, you
...
applicable law, Neo Exchanger shall withhold taxes related to your transactions,
...
result in withholding taxes by Neo Exchanger , to be remitted to tax authorities as defined
...
of rapid price movements.`,
  },
  {
    ...
    body: `Our fees and charges are set out here. Neo Exchanger may, in its discretion, update the
...
`,
  },
  {
    ...
    body: `We do not guarantee that the Neo Exchanger Services will be available at any particular
time or that Neo Exchanger Services will not be subject to unplanned service outages or
...
in the provision of Neo Exchanger Services. You may be subject to the terms &
conditions of these third parties, and Neo Exchanger may not be responsible for any loss
that these third parties may cause to you.`,
  },
  {
    heading: "K. Security Risk",
    body: `It is not possible for Neo Exchanger to eliminate all security risks. You are responsible for
keeping your Neo Exchanger Account password safe, and you may be responsible for all
the transactions under your Neo Exchanger Account, whether you authorized them or
